...
function Education({educations}: Props) {
  ...
  <div className='xl:w-5/6 w-full  flex space-x-5 overflow-x-scroll px-10 snap-x snap-mandatory scrollbar-thin scroll-smooth sm:scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#FFE55C]/60'>
